...
print("")
print(f"A newer version of your system is available ({latest_version}).")
print("")
print("It updates how your system runs — things like operating guidelines, skills,")
print("and safety routines. Nothing has changed in your system yet.")
print("")
print("To see exactly what would change and decide whether to apply it, run:")
print("")
print(f"  {review_cmd}")
print("")
print("That command shows you the differences and walks you through the decision.")
print("You are always in control — nothing applies until you say so.")
print("")
