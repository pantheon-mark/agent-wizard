...
This document is part of the operating layer your system maintains. When a newer
version of the system is published, this note explains how its operating-layer
improvements reach you: through the upgrade path, which keeps your own edits and
saves the new wording for you to review. Nothing here changes the safety steps.
