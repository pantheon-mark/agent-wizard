...
writer that read could not comply.** Under ADR-0046's coarse gate that made
acceptance permanently unreachable project-wide.

STEP 0 (``external_review/v0.19.0_step0_fresh_build_read_gap_2026-07-25.md``)
...
Entrypoint"). See ``external_review/cut1.6_design_consult_2026-07-25.md`` and
the disposition in ``external_review/cut1.6_scope_design_2026-07-25.md`` § D-1.
...
which changes its identity, breaks the ADR-0039 4-way identity invariant, and is
...
def _import_capability_module(project_root: Path, capability_id: str) -> Any:
    ...
    Uses the ADR-0039 4-way identity invariant (``capability_id == module
