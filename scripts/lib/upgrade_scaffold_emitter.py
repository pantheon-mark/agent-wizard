...
def render_command_surface() -> str:
    ...
    lines = [
        ...
        "",
        "The simplest way: just ask your system to check for updates (say \"check for",
        "updates\" or \"is there a new version\"). It runs the check for you, tells you in",
        "plain language what is available, and never applies anything without your OK.",
        "",
        "If you prefer to run it yourself, ask the wizard to run an upgrade check against",
        "this project. It reports the available versions, what would change, and whether",
        "any files you have edited would be affected — without changing anything.",
        "",
        "```",
