...
# already present (mirrors the real, hand-maintained
# agents/lib/external_write/registered_adapters.py shipped by this task --
# duplicated here, not imported, per this module's own boundary discipline:
# it does not import from the external_write package). Only used as a
# fallback for a project whose lib files were not yet copied in; a real
# operator project already has this file (lib-emitted) before any capability
# is ever added, so the normal path is "read existing content, append one
# import line".
_REGISTERED_ADAPTERS_BASELINE = (
    '"""Static adapter-registration import list -- see the shipped '
    'agents/lib/external_write/registered_adapters.py for the full '
    'rationale (Task 7 / F-37). GENERATED/regenerated by '
    'wizard/scripts/lib/capability_code_scaffold.py -- do not hand-edit the '
    'import list below; add a capability adapter instead.\n"""\n\n'
    "import external_write.adapters_gmail  # noqa: F401\n"
)
