...
# The derivation classes (mirror the derived-record contract enum) plus the agent-intent prompt.
PROMPT_NAMES = {"extraction", "synthesis", "classification", "policy", "auto", "authoring",
                "projection", "agent-intent"}
