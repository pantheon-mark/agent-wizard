...
**Apply the Operator Interaction Contract** (`wizard/interview/_operator_interaction_contract.md`) to every proposal and question in this step — read it now if you have not this session; it is the canonical voice + grounding + recording rule. For this step in particular: move from a grounded proposal straight into the question. The wizard shows it is listening by grounding each proposal in what the operator already said, not by narrating that it heard them.
...
- Constraints: *"Beyond the things you already told me it should always check with you before doing — any other things this system should always or never do?"*
...
> One more question, to make sure I build the right thing:
>
